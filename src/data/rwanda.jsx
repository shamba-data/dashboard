...
export const lineChartData = [
  [
    ...
    { x: new Date(2016, 0, 1), y: 36 },
    { x: new Date(2017, 0, 1), y: 38 },
    { x: new Date(2018, 0, 1), y: 54 },
    { x: new Date(2019, 0, 1), y: 57 },
    { x: new Date(2020, 0, 1), y: 70 }
  ],
  [
    { x: new Date(2014, 0, 1), y: 28 },
    { x: new Date(2015, 0, 1), y: 44 },
    { x: new Date(2016, 0, 1), y: 48 },
    { x: new Date(2017, 0, 1), y: 50 },
    { x: new Date(2018, 0, 1), y: 66 },
    { x: new Date(2019, 0, 1), y: 78 },
    { x: new Date(2020, 0, 1), y: 84 }
  ],

  [
    { x: new Date(2014, 0, 1), y: 10 },
    { x: new Date(2015, 0, 1), y: 20 },
    { x: new Date(2016, 0, 1), y: 30 },
    { x: new Date(2017, 0, 1), y: 39 },
